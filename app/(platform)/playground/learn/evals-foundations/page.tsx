    ...
    <div className="min-h-[calc(100vh-57px)]">
      <div className="max-w-[780px] mx-auto px-6 pt-14 pb-24">
        ...
        <div className="mb-12">
          ...
          >
            Course · {totalLessons} Lessons · {EVALS_COURSE.estimatedMinutes} Minutes
          </p>
          <h1
        ...
        <div className="space-y-10">
          {EVALS_COURSE.modules.map((module, mIdx) => (
            <div key={module.slug}>
              {/* Module header */}
              ...
              <div className="space-y-2">
                {module.lessons.map(lesson => (
                  <Link
                    key={lesson.slug}
                    href={`/playground/learn/evals-foundations/${lesson.slug}`}
        ...
        >
          ...
          >
            Ten lessons. Five artifacts. One operational eval system for an AI product.
          </p>
          <div className="space-y-2">
            {[
              { num: 1, label: 'A rubric for the Triage Agent', lesson: 4 },
              { num: 2, label: 'An evaluator architecture diagram', lesson: 6 },
              { num: 3, label: 'A calibrated LLM judge prompt', lesson: 7 },
              { num: 4, label: 'A production monitoring plan', lesson: 9 },
              { num: 5, label: 'A failure-tracing playbook', lesson: 10 },
            ].map(artifact => (
              <div key={artifact.num} className="flex items-center gap-3">
                <span
                  className="font-mono"
                ...
                <span
                  style={{ fontSize: '13px', color: 'rgba(255,255,255,0.55)', fontFamily: 'var(--font-dm-sans)' }}
                >
                  {artifact.label}
                </span>
                <span
